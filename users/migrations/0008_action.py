# Generated by Django 5.1.6 on 2025-04-28 22:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created'],
                'indexes': [models.Index(fields=['-created'], name='users_actio_created_064fed_idx'), models.Index(fields=['target_ct', 'target_id'], name='users_actio_target__c0aa69_idx')],
            },
        ),
    ]
